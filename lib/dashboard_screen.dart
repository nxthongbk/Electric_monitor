...
import 'widgets/round_button1.dart';
import 'package:web_socket_channel/web_socket_channel.dart';
import 'package:shared_preferences/shared_preferences.dart';
//import 'package:web_socket_channel/io.dart';
//import 'login_screen.dart' as LoginScreen;
//String end = LoginScreen.str1;

class DashboardScreen extends StatefulWidget {
  static const routeName = '/dashboard';
  //final String url;
  final WebSocketChannel channel;
  DashboardScreen({this.channel});
  //final WebSocketChannel channel = IOWebSocketChannel.connect('${uRl}+${url}+end1');
...
class _DashboardScreenState extends State<DashboardScreen>
      ...
      child: FadeIn(
        ...
        child: Column(
          ...
          children: <Widget>[
                  ...
                  return Center(
                    //padding: const EdgeInsets.symmetric(vertical: 24.0),
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text(snapshot.hasData ? ((json.decode(snapshot.data)['type'] == "message") ? "${json.decode(snapshot.data)['value']['elems']['virtual']['em2m_meter']['Power']}" : "") : "", style: theme.textTheme.headline3.copyWith(
                          ...
                          SizedBox(width: 35),
                          Text(snapshot.hasData ? ((json.decode(snapshot.data)['type'] == "message") ? "${json.decode(snapshot.data)['value']['elems']['virtual']['em2m_meter']['Voltage']}" : "") : "", style: theme.textTheme.headline3.copyWith(
                            fontWeight: FontWeight.w200,
                            color: accentColor.shade400,)),
                          SizedBox(width: 5),
                          Text(
                          ...
                          SizedBox(width: 35),
                          Text(snapshot.hasData ? ((json.decode(snapshot.data)['type'] == "message") ? "${json.decode(snapshot.data)['value']['elems']['virtual']['em2m_meter']['Current']}" : "") : "", style: theme.textTheme.headline3.copyWith(
                            fontWeight: FontWeight.w200,
                            color: accentColor.shade400,)),
                          SizedBox(width: 5),
                          Text(
            ...
            Text('Power', style: theme.textTheme.caption),
          ],
        ),
      ),
    );
  ...
  Widget _buildButton({Widget icon, String label, Interval interval}) {
    return RoundButton1(
      ...
      onPressed: () {
        widget.channel.sink.add(json.encode({"msgId": "my-request","object": "event","type": "subscribe","streamId": "s5fc604ed0272455c177aa32f"}));
      },
    );
  }
